...
class ProgramProgressMeter(object):
    ...
    def _is_course_complete(self, course):
        ...
        A course is completed if the user has earned a certificate for any of the
        nested course runs.
    ...
    def _is_course_in_progress(self, course):
        ...
        A user is considered to be in the process of completing a course if they're
        enrolled in any of the nested course runs.
